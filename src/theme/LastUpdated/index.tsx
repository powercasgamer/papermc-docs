...
function LastUpdatedInCommit({
  ...
  return (
    <Translate
      ...
      description="The words used to describe by who the page has been last updated"
      values={{
        commit: <Link to={"https://github.com/PaperMC/docs/commit/" + lastUpdatedCommit}>{lastUpdatedCommit}</Link>
      }}>
      {' in {commit}'}
    </Translate>
  );
    ...
    <span className={ThemeClassNames.common.lastUpdated}>
      <Translate
        ...
        values={{
          ...
          commit: (
            <LastUpdatedInCommit lastUpdatedCommit={lastUpdatedCommit} />
          ),
        }}>
